...
First, you need a programming language. [This specialization](https://imp.i384100.net/6yyWGV) from the University of Michigan is about learning to use Python and creating things on your own.
...
This specialization in [Applied Data Science with Python](https://imp.i384100.net/JKKJZa) gives an intro to many modern machine learning methods that you should know about. Not a thorough grinding, but you will get the tools to build your models.
...
Here comes the Game Changer [Machine Learning specialization](https://imp.i384100.net/Z66Xe1). It contains the maths behind many of the Machine Learning algorithms.
...
SQL has also become a de facto standard of working with Big Data Tools like Apache Spark. This [SQL specialization](https://imp.i384100.net/POOKvY) from UC Davis will teach you about SQL as well as how to use SQL for distributed computing.
...
Andrew NG is back again with his new [Deep Learning Specialization](https://imp.i384100.net/LXZO13). And this is Pure Gold.
...
A structured way to learn Pytorch is by taking this course on [Deep Neural Networks with Pytorch](https://imp.i384100.net/e11q5j). From the course website:
...
**One of the best resources I found to learn algorithms is the [Algorithm Specialization on Coursera by UCSanDiego](https://imp.i384100.net/6eE6qK).** From the specialization website:
