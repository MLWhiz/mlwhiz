...
I also started auditing the [Algorithm Specialization on Coursera by UCSanDiego](https://imp.i384100.net/6eE6qK) around this time period, which sort of provided me with an idea about the sort of content taught at undergraduate universities to deal with the coding interviews.
...
If you want to read up more on Algorithms and Data Structures in a more structured way, here is an [Algorithm Specialization on Coursera by UCSanDiego](https://imp.i384100.net/6eE6qK). I sort of audited this course while preparing.
