...
![Source: Image by Author](https://cdn-images-1.medium.com/max/2000/1*QURFn2PSfZHtK0eVdYpvmw.png)*Source: Image by Author*
...
![Source: Image by Author](https://cdn-images-1.medium.com/max/2000/1*qcx4tRoOkui_jvHWcYzOoQ.png)*Source: Image by Author*
...
![Source: Author Image](https://cdn-images-1.medium.com/max/3830/1*Md4U9S15hmHrmiCBsZU_dw.png)*Source: Author Image*
...
![We start by getting FPR and TPR for various threshold values. Source: Author Image](https://cdn-images-1.medium.com/max/3640/1*4BQGdibvSKDUCaSn7QoC_Q.png)*We start by getting FPR and TPR for various threshold values. Source: Author Image*
...
![Source: Image by Author](https://cdn-images-1.medium.com/max/3652/1*nyvYMHa6t86iLys0Cl6mCw.png)*Source: Image by Author*
...
![[Source](https://en.wikipedia.org/wiki/Receiver_operating_characteristic#/media/File:Roc-draft-xkcd-style.svg): Wikipedia](https://cdn-images-1.medium.com/max/5120/0*IwhTa5HDpvyUEVbG.png)*[Source](https://en.wikipedia.org/wiki/Receiver_operating_characteristic#/media/File:Roc-draft-xkcd-style.svg): Wikipedia*
...
![](https://cdn-images-1.medium.com/max/3516/1*RXui8jBWKq7imsJppr2rSQ.png)

![Scaling(Left) and Exponentiation Rank Order(Right)](https://cdn-images-1.medium.com/max/3512/1*ISF-awHw6ABH3PnEQgnlgA.png)*Scaling(Left) and Exponentiation Rank Order(Right)*
